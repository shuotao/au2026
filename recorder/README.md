...
**[⬇ au2026rec-0.1.0-win64.zip](https://github.com/shuotao/au2026/releases/latest)** — 免安裝，解壓縮後點兩下 `au2026rec.exe`，選 **1** 走引導設定。不需要 Python。

需要 Windows 10/11、Chrome（或 Edge / Brave）、OBS Studio 28 以上。

**要用的人看 [使用說明.md](使用說明.md)**（解壓縮 → 點兩下 → 選 1 引導設定，不用編譯）
**開發或想自己打包的人** —— 課表怎麼匯出、檔案放哪、第一場要盯什麼，
都寫在那裡。本文件偏技術細節與開發。
